...
-- 1. Print all rows and columns of the datset
describe customer;
describe order_line;
describe orders;
describe part;
...
-- 14.	Create a new table of customer name, last name, and first name from customer and sales rep table by matching 
-- up their primary key
